...
var serviceBusName = '${resourcesPrefix}-sb-${uniqueString(resourceGroup().id)}'
var serviceBusQueueName = 'demo-queue'
...
output azureServiceBusNamespace string = serviceBus.name
